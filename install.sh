...
gfortran -w -c genetic.mod.f90 genetic2.mod.f90
...
gfortran -w -c nexus.mod.f03 nexus2.mod.f03
...
gfortran -w -O2 -fexceptions -fno-underscoring -fcheck=all gnuplotter.mod.o aleas.mod.o general.mod.o neighboring.mod.f90 genetic.mod.o genetic2.mod.o energy.mod.o shell.mod.o io.mod.o pola.mod.o mitosis.mod.o growth.mod.o death.mod.o single_node.mod.o ic.mod.o ecm.mod.o nexus.mod.o nexus2.mod.o biomechanic.mod.o model.mod.o inicial.mod.o automaticon.mod.f90 geompack3.f90 elli_MN4.o -o EMaker 

echo 'linking muta.e'
gfortran -w -O2 -g -fexceptions -fno-underscoring -fcheck=all aleas.mod.o general.mod.o neighboring.mod.f90 genetic.mod.o genetic2.mod.o energy.mod.o shell.mod.o io.mod.o mutation.mod.o pola.mod.o mitosis.mod.o growth.mod.o death.mod.o single_node.mod.o ic.mod.o ecm.mod.o conservative_R.mod.o analysis.mod.o fitmo.mod.o nexus.mod.o nexus2.mod.f03 biomechanic.mod.o model.mod.o inicial.mod.o automaticon.mod.f90 geompack3.f90 muta.o -o muta.e 
...
echo 'linking select.e'
gfortran select.f90 -o select.e

echo 'linking whomut.e'
gfortran whomut.f90 -o whomut.e
...
mv src/core/select.e bin
mv src/core/whomut.e bin
