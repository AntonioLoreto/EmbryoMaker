...
if (randseed == 0) then
   ...
   open(836,file=rseed)                                        
      write(836,*) numids        !!evolution experiments are repeatable if you use the same number of cpus (cpus=numids)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call random_number(fits) !!FIRST RANDOM NUMBER CALL IN EVO ALGORITHM AND THE RAND_SEED IS NOT INSTANTIATED!  !!>> HC 20-1-2022  Random initial fitness
